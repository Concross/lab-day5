...
function multiply(a, b) { //eslint-disable-line
  var product = a * b;
  var problemMessage = 'The product of ' + a + ' and ' + b + ' is ' + product + '.';
  return [product, problemMessage];
}
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  var sumArrayMessage = sumArr[0] + ',' + sumArr[1] + ',' + sumArr[2] + ' was passed in as an array of numbers, and ' + totalSum + ' is their sum.';
  return [totalSum, sumArrayMessage];
}
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  var productMessage = 'The numbers ' + multArr[0] + ',' + multArr[1] + ',' + multArr[2] + ' have a product of ' + totalProduct + '.';
  return [totalProduct, productMessage];
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  for (var i = 0; i < dynamicArray.length - 1; i++){
    ...
    if (i === 0){
      totalProduct = multiply(dynamicArray[0], dynamicArray[1])[0];
    } else if (i !== dynamicArray.length - 1){
      totalProduct = multiply(totalProduct, dynamicArray[i + 1])[0];
    } else {
      totalProduct = multiply(totalProduct, dynamicArray[i])[0];
    }
  }
  
  productMessage += dynamicArray[i] + ' have a product of ' + totalProduct + '.';
  return [totalProduct, productMessage];
}
